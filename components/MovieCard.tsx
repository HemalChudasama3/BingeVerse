    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            <div className="
                ...
                group-hover:-translate-y-[6vw] shadow-lg shadow-black
                ...
                ">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        " onClick={() => router.push(`/watch/${data?.id}`)}>
                            <BsFillPlayFill color="red" size={30} />
                        </div>
                        <FavoriteButton movieId={data?.id} />
                        <div onClick={() => openModal(data?.id)} className="
                            cursor-pointer ml-auto group/item
                    ...
                    <div className="fexl flex-row mt-4 gap-2 items-center">
